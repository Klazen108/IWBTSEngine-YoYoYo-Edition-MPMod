...
for(var i=0; i<ds_map_size(m); i+=1) {
    ...
    if (!is_undefined(insthash)) htme_debugger("htme_roomend",htme_debug.DEBUG,"Checking instance with hash "+insthash);
    else {
        htme_debugger("htme_roomend",htme_debug.DEBUG,"Undefined hash in map!");
